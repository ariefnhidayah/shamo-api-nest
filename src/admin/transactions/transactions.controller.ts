...
export class TransactionsController {
  ...
  @UseGuards(AdminGuard)
  async updatePaymentStatus(@Request() req, @Param('id') id: number, @Body() changePaymentStatusDto: ChangePaymentStatusDto) {
    return await this.transactionsService.changePaymentStatus(req, id, changePaymentStatusDto)
  }

  @ApiOperation({ summary: "Update Transaction Status" })
  @Put('/:id/transaction-status')
  @UseGuards(AdminGuard)
  async updateTransactionStatus(@Request() req, @Param('id') id: number, @Body() changeTransactionStatusDto: ChangeTransactionStatusDto) {
    return await this.transactionsService.changeTransactionStatus(req, id, changeTransactionStatusDto)
  }
