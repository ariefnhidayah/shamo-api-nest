...
export class TransactionsService {
  constructor(
    ...
    private transactionItem: Repository<TransactionItem>,
    @InjectRepository(Product) private product: Repository<Product>,
    @InjectRepository(ProductGallery)
    private productGallery: Repository<ProductGallery>,
  ...
  async gets(
    ...
    let { page, limit, transaction_status, payment_status } =
      getsTransactionDto;
  ...
  async updatePaymentProof(
    request,
    id: number,
    updatePaymentProof: UpdatePaymentProofDto,
  ): Promise<ResponseApi> {
    const response = new ResponseApi();
